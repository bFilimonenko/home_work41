...
document.getElementById("navigation").addEventListener("click", async (event) => {
  ...
  const data = await loadEntities(API_URLS[entityType]);
...
loadMoreButton.addEventListener("click", async (event) => {
  ...
  showEntities(await loadEntities(nextPageUrl), entityType);
